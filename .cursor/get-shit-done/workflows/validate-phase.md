...
<required_reading>
@D:/projetos/Estudo/devsquad/.cursor/get-shit-done/references/ui-brand.md
</required_reading>
...
```bash
AUDITOR_MODEL=$(node "D:/projetos/Estudo/devsquad/.cursor/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-nyquist-auditor --raw)
...
```
Task(
  prompt="Read D:/projetos/Estudo/devsquad/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projetos/Estudo/devsquad/.cursor/get-shit-done/templates/VALIDATION.md`
...
node "D:/projetos/Estudo/devsquad/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
