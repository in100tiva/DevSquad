...
```bash
ARCHIVE=$(node "D:/projetos/Estudo/devsquad/.cursor/get-shit-done/bin/gsd-tools.cjs" milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
**If doesn't exist:** Create from template at `D:/projetos/Estudo/devsquad/.cursor/get-shit-done/templates/retrospective.md`.
