...
- **Global scope**: `D:/projetos/Estudo/devsquad/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/projetos/Estudo/devsquad/.cursor/notes/`)
...
2. Glob `D:/projetos/Estudo/devsquad/.cursor/notes/*.md` (if directory exists) — global notes
...
2. **No `.planning/`**: Falls back to global `D:/projetos/Estudo/devsquad/.cursor/notes/` — works in any directory
