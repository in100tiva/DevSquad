---
name: gsd-estatisticas
description: "Exibir estatísticas do projeto — fases, planos, requisitos, métricas git e cronograma"
---

<cursor_skill_adapter>
## A. Invocação da Skill
- Esta skill é invocada quando o usuário menciona `gsd-estatisticas` ou descreve uma tarefa correspondente a esta skill.
...
<objective>
Exibir estatísticas abrangentes do projeto incluindo progresso de fases, métricas de execução de planos, conclusão de requisitos, estatísticas de histórico git e cronograma do projeto.
</objective>

<execution_context>
@D:/projetos/Estudo/devsquad/.cursor/get-shit-done/workflows/estatisticas.md
</execution_context>

<process>
Execute o workflow de estatísticas de @D:/projetos/Estudo/devsquad/.cursor/get-shit-done/workflows/estatisticas.md do início ao fim.
</process>
